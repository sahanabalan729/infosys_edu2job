...
export default function Prediction() {
  ...
  const handlePredict = async () => {
    ...
    try {
      ...
      if (!predictions.length) {
        setResult([
          {
            job: "No predictions found",
            confidence: 0,
            explanation:
              "The ML model didn’t return any job roles. Check backend output.",
          },
        ]);
      } else {
      ...
      // ✅ Save only top-1 result to DB
      if (predictions.length > 0) {
        const topJob = predictions[0];
        const savePayload = {
          ...payload,
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-purple-500 via-indigo-600 to-blue-500 px-6 py-10 overflow-y-auto">
          ...
          <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="md:col-span-2">
              ...
              <CreatableSelect
                ...
                onChange={(val) =>
                  handleChange("skills", val ? val.map((v) => v.value) : [])
                }
              />
            </div>
